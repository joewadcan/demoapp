# -*- encoding: utf-8 -*-
# stub: actionmailer 4.2.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>.freeze, ["= 4.2.8"])
      s.add_runtime_dependency(%q<actionview>.freeze, ["= 4.2.8"])
      ...
      s.add_dependency(%q<actionpack>.freeze, ["= 4.2.8"])
      s.add_dependency(%q<actionview>.freeze, ["= 4.2.8"])
      s.add_dependency(%q<activejob>.freeze, ["= 4.2.8"])
